<template>
    <div class="page_right task_tab">
        ...
        <template style="margin-top: 10px">
            <el-tabs v-model="activeName" @tab-click="handleClick" class="header-block">
                <el-tab-pane label="解锁订单" name="first"></el-tab-pane>
                <el-tab-pane label="续费订单" name="second"></el-tab-pane>
            </el-tabs>
        ...
        methods: {
            ...
            handleClick(tab, event) {
                ...
                if(tab.index == '0') {
                    ...
                    this.$router.push('/user/order/fee')
                }
            },
            ...mapActions([
//            'commit_audi_createt'
